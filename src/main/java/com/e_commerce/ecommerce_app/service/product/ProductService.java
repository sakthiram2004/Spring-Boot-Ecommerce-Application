...
import com.e_commerce.ecommerce_app.repository.ImageRepository;
import com.e_commerce.ecommerce_app.repository.ProductRepository;
...
//
    ...
    private boolean productExist(String name,String branch){
        return productRepository.existsByNameAndBrand(name,branch);
    }
    ...
    private Product updateExistingProduct(Product existingProduct, ProductUpdateRequest request) {
        ...
        existingProduct.setDescription(request.getDiscription());
